...
BSJSParser.prototype["number"] = function $number() {
    return this._atomic(function() {
        var n;
        return this._seq("0x") && this._rule("hexLit", false, [], null, this["hexLit"]) && (n = this._getIntermediate(), true) && this._exec([ "number", n ]);
    }) || this._atomic(function() {
        var f;
        return this._list(function() {
...
BSJSParser.prototype["special"] = function $special() {
    var s;
    return (this._match("(") || this._match(")") || this._match("{") || this._match("}") || this._match("[") || this._match("]") || this._match(",") || this._match(";") || this._match("?") || this._match(":") || this._seq("!==") || this._seq("!=") || this._seq("===") || this._seq("==") || this._seq("=") || this._seq(">=") || this._match(">") || this._seq("<=") || this._match("<") || this._seq("++") || this._seq("+=") || this._match("+") || this._seq("--") || this._seq("-=") || this._match("-") || this._seq("*=") || this._match("*") || this._seq("/=") || this._match("/") || this._seq("%=") || this._match("%") || this._seq("&&=") || this._seq("&&") || this._seq("||=") || this._seq("||") || this._seq(">>>") || this._seq("<<<") || this._seq(">>") || this._seq("&=") || this._seq("|=") || this._seq("^=") || this._match("&") || this._match("|") || this._match("^") || this._match("~") || this._match(".") || this._match("!")) && (s = this._getIntermediate(), true) && this._exec([ s, s ]);
};
