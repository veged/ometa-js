...
var AbstractGrammar = ometajs_.globals.AbstractGrammar;

var BSJSParser = ometajs_.globals.BSJSParser;

var BSJSIdentity = ometajs_.globals.BSJSIdentity;

var BSJSTranslator = ometajs_.globals.BSJSTranslator;
...
BSJSParser.prototype["number"] = function $number() {
    return this._atomic(function() {
        var n;
        return this._match("0") && this._match("x") && this._rule("hexLit", false, [], null) && (n = this._getIntermediate(), true) && this._exec([ "number", n ]);
    }) || this._atomic(function() {
        var f;
        return this._list(function() {
...
BSJSParser.prototype["escapeChar"] = function $escapeChar() {
    ...
    return this._list(function() {
        return this._match("\\") && (this._atomic(function() {
            ...
            return this._rule("char", false, [], null);
        }));
    }, true) && (s = this._getIntermediate(), true) && this._exec(JSON.parse('"' + s + '"'));
};
...
BSJSParser.prototype["special"] = function $special() {
    ...
    return (this._match("(") || this._match(")") || this._match("{") || this._match("}") || this._match("[") || this._match("]") || this._match(",") || this._match(";") || this._match("?") || this._match(":") || this._atomic(function() {
        ...
        return this._match("|") && this._match("|");
    }) || this._match(".") || this._match("!")) && (s = this._getIntermediate(), true) && this._exec([ s, s ]);
};
...
BSJSParser.prototype["asgnExpr"] = function $asgnExpr() {
    ...
    return this._rule("condExpr", false, [], null) && (e = this._getIntermediate(), true) && (this._atomic(function() {
        ...
        var rhs;
        return this._rule("token", true, [ "+=" ], null) && this._rule("asgnExpr", false, [], null) && (rhs = this._getIntermediate(), true) && this._exec([ "mset", e, "+", rhs ]);
    }) || this._atomic(function() {
        var rhs;
        return this._rule("token", true, [ "-=" ], null) && this._rule("asgnExpr", false, [], null) && (rhs = this._getIntermediate(), true) && this._exec([ "mset", e, "-", rhs ]);
    }) || this._atomic(function() {
...
BSJSParser.prototype["orExpr"] = function $orExpr() {
    return this._atomic(function() {
        var x, y;
        return this._rule("orExpr", false, [], null) && (x = this._getIntermediate(), true) && this._rule("token", true, [ "||" ], null) && this._rule("andExpr", false, [], null) && (y = this._getIntermediate(), true) && this._exec([ "binop", "||", x, y ]);
    }) || this._atomic(function() {
        return this._rule("andExpr", false, [], null);
    });
};
...
BSJSParser.prototype["andExpr"] = function $andExpr() {
    return this._atomic(function() {
        var x, y;
        return this._rule("andExpr", false, [], null) && (x = this._getIntermediate(), true) && this._rule("token", true, [ "&&" ], null) && this._rule("eqExpr", false, [], null) && (y = this._getIntermediate(), true) && this._exec([ "binop", "&&", x, y ]);
    }) || this._atomic(function() {
...
BSJSParser.prototype["eqExpr"] = function $eqExpr() {
    return this._atomic(function() {
        ...
        return this._rule("eqExpr", false, [], null) && (x = this._getIntermediate(), true) && (this._atomic(function() {
            var y;
            return this._rule("token", true, [ "==" ], null) && this._rule("relExpr", false, [], null) && (y = this._getIntermediate(), true) && this._exec([ "binop", "==", x, y ]);
        }) || this._atomic(function() {
            var y;
            return this._rule("token", true, [ "!=" ], null) && this._rule("relExpr", false, [], null) && (y = this._getIntermediate(), true) && this._exec([ "binop", "!=", x, y ]);
        }) || this._atomic(function() {
...
BSJSParser.prototype["relExpr"] = function $relExpr() {
    return this._atomic(function() {
        ...
        return this._rule("relExpr", false, [], null) && (x = this._getIntermediate(), true) && (this._atomic(function() {
            var y;
            return this._rule("token", true, [ ">" ], null) && this._rule("addExpr", false, [], null) && (y = this._getIntermediate(), true) && this._exec([ "binop", ">", x, y ]);
        }) || this._atomic(function() {
            var y;
            return this._rule("token", true, [ ">=" ], null) && this._rule("addExpr", false, [], null) && (y = this._getIntermediate(), true) && this._exec([ "binop", ">=", x, y ]);
        }) || this._atomic(function() {
            ...
            var y;
            return this._rule("token", true, [ "instanceof" ], null) && this._rule("addExpr", false, [], null) && (y = this._getIntermediate(), true) && this._exec([ "binop", "instanceof", x, y ]);
        }));
    }) || this._atomic(function() {
...
BSJSParser.prototype["addExpr"] = function $addExpr() {
    return this._atomic(function() {
        var x, y;
        return this._rule("addExpr", false, [], null) && (x = this._getIntermediate(), true) && this._rule("token", true, [ "+" ], null) && this._rule("mulExpr", false, [], null) && (y = this._getIntermediate(), true) && this._exec([ "binop", "+", x, y ]);
    }) || this._atomic(function() {
        var x, y;
        return this._rule("addExpr", false, [], null) && (x = this._getIntermediate(), true) && this._rule("token", true, [ "-" ], null) && this._rule("mulExpr", false, [], null) && (y = this._getIntermediate(), true) && this._exec([ "binop", "-", x, y ]);
    }) || this._atomic(function() {
...
BSJSParser.prototype["mulExpr"] = function $mulExpr() {
    return this._atomic(function() {
        var x, y;
        return this._rule("mulExpr", false, [], null) && (x = this._getIntermediate(), true) && this._rule("token", true, [ "*" ], null) && this._rule("unary", false, [], null) && (y = this._getIntermediate(), true) && this._exec([ "binop", "*", x, y ]);
    }) || this._atomic(function() {
        var x, y;
        return this._rule("mulExpr", false, [], null) && (x = this._getIntermediate(), true) && this._rule("token", true, [ "/" ], null) && this._rule("unary", false, [], null) && (y = this._getIntermediate(), true) && this._exec([ "binop", "/", x, y ]);
    }) || this._atomic(function() {
...
BSJSParser.prototype["unary"] = function $unary() {
    return this._atomic(function() {
        var p;
        return this._rule("token", true, [ "-" ], null) && this._rule("postfix", false, [], null) && (p = this._getIntermediate(), true) && this._exec([ "unop", "-", p ]);
    }) || this._atomic(function() {
        var p;
        return this._rule("token", true, [ "+" ], null) && this._rule("postfix", false, [], null) && (p = this._getIntermediate(), true) && this._exec([ "unop", "+", p ]);
    }) || this._atomic(function() {
        var p;
        return this._rule("token", true, [ "++" ], null) && this._rule("postfix", false, [], null) && (p = this._getIntermediate(), true) && this._exec([ "preop", "++", p ]);
    }) || this._atomic(function() {
        var p;
        return this._rule("token", true, [ "--" ], null) && this._rule("postfix", false, [], null) && (p = this._getIntermediate(), true) && this._exec([ "preop", "--", p ]);
    }) || this._atomic(function() {
        var p;
        return this._rule("token", true, [ "!" ], null) && this._rule("unary", false, [], null) && (p = this._getIntermediate(), true) && this._exec([ "unop", "!", p ]);
    }) || this._atomic(function() {
        var p;
        return this._rule("token", true, [ "void" ], null) && this._rule("unary", false, [], null) && (p = this._getIntermediate(), true) && this._exec([ "unop", "void", p ]);
    }) || this._atomic(function() {
        var p;
        return this._rule("token", true, [ "delete" ], null) && this._rule("unary", false, [], null) && (p = this._getIntermediate(), true) && this._exec([ "unop", "delete", p ]);
    }) || this._atomic(function() {
        var p;
        return this._rule("token", true, [ "typeof" ], null) && this._rule("unary", false, [], null) && (p = this._getIntermediate(), true) && this._exec([ "unop", "typeof", p ]);
    }) || this._atomic(function() {
...
BSJSParser.prototype["postfix"] = function $postfix() {
    ...
    return this._rule("primExpr", false, [], null) && (p = this._getIntermediate(), true) && (this._atomic(function() {
        return this._rule("spacesNoNl", false, [], null) && this._rule("token", true, [ "++" ], null) && this._exec([ "postop", "++", p ]);
    }) || this._atomic(function() {
        return this._rule("spacesNoNl", false, [], null) && this._rule("token", true, [ "--" ], null) && this._exec([ "postop", "--", p ]);
    }) || this._atomic(function() {
...
BSJSParser.prototype["re1stChar"] = function $re1stChar() {
    return this._atomic(function() {
        return this._atomic(function() {
            return !(this._match("*") && this._skip() && this._match("\\") && this._skip() && this._match("/") && this._skip() && this._match("["));
...
BSJSParser.prototype["reClassChar"] = function $reClassChar() {
    return this._atomic(function() {
        return !(this._match("[") && this._skip() && this._match("]"));
...
BSJSParser.prototype["stmt"] = function $stmt() {
    return this._atomic(function() {
        ...
        return this._rule("token", true, [ "for" ], null) && this._rule("token", true, [ "(" ], null) && (this._atomic(function() {
            var b;
            return this._rule("token", true, [ "var" ], null) && this._rule("binding", false, [], null) && (b = this._getIntermediate(), true) && this._exec([ "var", b ]);
        }) || this._atomic(function() {
            return this._rule("expr", false, [], null);
        })) && (v = this._getIntermediate(), true) && this._rule("token", true, [ "in" ], null) && this._rule("asgnExpr", false, [], null) && (e = this._getIntermediate(), true) && this._rule("token", true, [ ")" ], null) && this._rule("stmt", false, [], null) && (s = this._getIntermediate(), true) && this._exec([ "forIn", v, e, s ]);
    }) || this._atomic(function() {
        var e, cs;
