...
var reserved = [ "class", "enum", "export", "extends", "import", "super", "implements", "interface", "let", "package", "private", "protected", "public", "static", "yield" ];
...
BSJSTranslator.prototype["trans"] = function $trans() {
    var $l0, $l1, info, t, ans;
    return ($l0 = this, $l1 = $l0._info, $l0._info = this._source._info || this._info, true) && (this._exec(this._info) && (info = this._getIntermediate(), true) && this._list(function() {
        return this._skip() && (t = this._getIntermediate(), true) && this._rule("apply", false, [ t ], null, this["apply"]) && (ans = this._getIntermediate(), true);
    }) && this._exec(function() {
        return this._cons(ans, info);
    }.call(this)) && ($l0._info = $l1, true) || ($l0._info = $l1, false));
};

BSJSTranslator.prototype["mtrans"] = function $mtrans() {
    var rs;
    return this._any(function() {
        return this._atomic(function() {
            return this._rule("trans", false, [], null, this["trans"]);
        });
    }) && (rs = this._getIntermediate(), true) && this._exec(function() {
        return this._arrcons(rs);
    }.call(this));
};
...
BSJSTranslator.prototype["curlyTrans"] = function $curlyTrans() {
    return this._atomic(function() {
        ...
        var rs;
        return this._list(function() {
            return this._match("begin") && this._rule("mtrans", false, [], null, this["mtrans"]) && (rs = this._getIntermediate(), true);
        }) && this._exec(function() {
            return this._cons("{").cons(rs.join(";")).cons("}");
        }.call(this));
    }) || this._atomic(function() {
        var r;
        return this._rule("trans", false, [], null, this["trans"]) && (r = this._getIntermediate(), true) && this._exec(this._cons("{").cons(r).cons("}"));
    });
};
...
BSJSTranslator.prototype["arr"] = function $arr() {
    var $l2, $l3, xs;
    return ($l2 = this, $l3 = $l2.op, $l2.op = "[]", true) && (this._rule("mtrans", false, [], null, this["mtrans"]) && (xs = this._getIntermediate(), true) && this._exec(function() {
        return this._cons("[").cons(xs.join(",")).cons("]");
    }.call(this)) && ($l2.op = $l3, true) || ($l2.op = $l3, false));
};

BSJSTranslator.prototype["unop"] = function $unop() {
    var op, prevOp, $l4, $l5, t;
    return this._skip() && (op = this._getIntermediate(), true) && this._exec(this.op) && (prevOp = this._getIntermediate(), true) && ($l4 = this, $l5 = $l4.op, $l4.op = "u" + op, true) && (this._rule("trans", false, [], null, this["trans"]) && (t = this._getIntermediate(), true) && this._exec(function() {
        var res;
...
BSJSTranslator.prototype["getp"] = function $getp() {
    var $l6, $l7, fd, tfd, x;
    return ($l6 = this, $l7 = $l6.op, $l6.op = ".", true) && (this._skip() && (fd = this._getIntermediate(), true) && this._rule("trans", false, [ fd ], null, this["trans"]) && (tfd = this._getIntermediate(), true) && this._rule("trans", false, [], null, this["trans"]) && (x = this._getIntermediate(), true) && this._exec(function() {
...
BSJSTranslator.prototype["set"] = function $set() {
    var prevOp, lhs, $l8, $l9, rhs;
    return this._exec(this.op) && (prevOp = this._getIntermediate(), true) && this._rule("trans", false, [], null, this["trans"]) && (lhs = this._getIntermediate(), true) && ($l8 = this, $l9 = $l8.op, $l8.op = "=", true) && (this._rule("trans", false, [], null, this["trans"]) && (rhs = this._getIntermediate(), true) && this._exec(function() {
...
BSJSTranslator.prototype["mset"] = function $mset() {
    var prevOp, lhs, op, $l10, $l11, rhs;
    return this._exec(this.op) && (prevOp = this._getIntermediate(), true) && this._rule("trans", false, [], null, this["trans"]) && (lhs = this._getIntermediate(), true) && this._skip() && (op = this._getIntermediate(), true) && ($l10 = this, $l11 = $l10.op, $l10.op = op + "=", true) && (this._rule("trans", false, [], null, this["trans"]) && (rhs = this._getIntermediate(), true) && this._exec(function() {
...
BSJSTranslator.prototype["binop"] = function $binop() {
    var op, prevOp, $l12, $l13, x, y;
    return this._skip() && (op = this._getIntermediate(), true) && this._exec(this.op) && (prevOp = this._getIntermediate(), true) && ($l12 = this, $l13 = $l12.op, $l12.op = op, true) && (this._rule("trans", false, [], null, this["trans"]) && (x = this._getIntermediate(), true) && this._rule("trans", false, [], null, this["trans"]) && (y = this._getIntermediate(), true) && this._exec(function() {
...
BSJSTranslator.prototype["postop"] = function $postop() {
    var op, prevOp, $l16, $l17, x;
    return this._skip() && (op = this._getIntermediate(), true) && this._exec(this.op) && (prevOp = this._getIntermediate(), true) && ($l16 = this, $l17 = $l16.op, $l16.op = "u" + op, true) && (this._rule("trans", false, [], null, this["trans"]) && (x = this._getIntermediate(), true) && this._exec(function() {
        var res = x.cons(op);
        if (BSJSTranslator.comparePriorities(prevOp, "u" + op)) {
            res = this._cons("(").cons(res).cons(")");
        }
...
BSJSTranslator.prototype["return"] = function $return() {
    var x;
    return this._rule("trans", false, [], null, this["trans"]) && (x = this._getIntermediate(), true) && this._exec(function() {
        return this._cons("return ").cons(x);
    }.call(this));
};

BSJSTranslator.prototype["with"] = function $with() {
    var x, s;
    return this._rule("trans", false, [], null, this["trans"]) && (x = this._getIntermediate(), true) && this._rule("curlyTrans", false, [], null, this["curlyTrans"]) && (s = this._getIntermediate(), true) && this._exec(function() {
        return this._cons("with(").cons(x).cons(")").cons(s);
    }.call(this));
};

BSJSTranslator.prototype["label"] = function $label() {
    var name, s;
    return this._skip() && (name = this._getIntermediate(), true) && this._rule("curlyTrans", false, [], null, this["curlyTrans"]) && (s = this._getIntermediate(), true) && this._exec(function() {
        return this._cons(";" + name + ":").cons(s);
    }.call(this));
};

BSJSTranslator.prototype["if"] = function $if() {
    var cond, t, e;
    return this._rule("trans", false, [], null, this["trans"]) && (cond = this._getIntermediate(), true) && this._rule("curlyTrans", false, [], null, this["curlyTrans"]) && (t = this._getIntermediate(), true) && this._rule("curlyTrans", false, [], null, this["curlyTrans"]) && (e = this._getIntermediate(), true) && this._exec(function() {
        return this._cons("if(").cons(cond).cons(")").cons(t).cons("else").cons(e);
    }.call(this));
};

BSJSTranslator.prototype["condExpr"] = function $condExpr() {
    var prevOp, $l18, $l19, cond, t, e;
    return this._exec(this.op) && (prevOp = this._getIntermediate(), true) && ($l18 = this, $l19 = $l18.op, $l18.op = "?:", true) && (this._rule("trans", false, [], null, this["trans"]) && (cond = this._getIntermediate(), true) && this._rule("trans", false, [], null, this["trans"]) && (t = this._getIntermediate(), true) && this._rule("trans", false, [], null, this["trans"]) && (e = this._getIntermediate(), true) && this._exec(function() {
...
BSJSTranslator.prototype["while"] = function $while() {
    var cond, body;
    return this._rule("trans", false, [], null, this["trans"]) && (cond = this._getIntermediate(), true) && this._rule("curlyTrans", false, [], null, this["curlyTrans"]) && (body = this._getIntermediate(), true) && this._exec(function() {
        return this._cons("while(").cons(cond).cons(")").cons(body);
    }.call(this));
};

BSJSTranslator.prototype["doWhile"] = function $doWhile() {
    var body, cond;
    return this._rule("curlyTrans", false, [], null, this["curlyTrans"]) && (body = this._getIntermediate(), true) && this._rule("trans", false, [], null, this["trans"]) && (cond = this._getIntermediate(), true) && this._exec(function() {
        return this._cons("do").cons(body).cons("while(").cons(cond).cons(")");
    }.call(this));
};

BSJSTranslator.prototype["for"] = function $for() {
    var init, cond, upd, body;
    return this._rule("trans", false, [], null, this["trans"]) && (init = this._getIntermediate(), true) && this._rule("trans", false, [], null, this["trans"]) && (cond = this._getIntermediate(), true) && this._rule("trans", false, [], null, this["trans"]) && (upd = this._getIntermediate(), true) && this._rule("curlyTrans", false, [], null, this["curlyTrans"]) && (body = this._getIntermediate(), true) && this._exec(function() {
        return this._cons("for(").cons(init).cons(";").cons(cond).cons(";").cons(upd).cons(")").cons(body);
    }.call(this));
};

BSJSTranslator.prototype["forIn"] = function $forIn() {
    var x, arr, body;
    return this._rule("trans", false, [], null, this["trans"]) && (x = this._getIntermediate(), true) && this._rule("trans", false, [], null, this["trans"]) && (arr = this._getIntermediate(), true) && this._rule("curlyTrans", false, [], null, this["curlyTrans"]) && (body = this._getIntermediate(), true) && this._exec(function() {
        return this._cons("for(").cons(x).cons(" in ").cons(arr).cons(")").cons(body);
    }.call(this));
};
        ...
        return this._any(function() {
            return this._atomic(function() {
                return this._rule("trans", false, [], null, this["trans"]) && (x = this._getIntermediate(), true) && (this._atomic(function() {
                    ...
                    return this._rule("empty", false, [], null, this["empty"]) && this._exec(x.cons(";"));
                }));
            });
        }) && (xs = this._getIntermediate(), true) && this._exec(this._cons("{").cons(xs.join("")).cons("}"));
    });
};

BSJSTranslator.prototype["func"] = function $func() {
    var name, args, body;
    return this._skip() && (name = this._getIntermediate(), true) && this._skip() && (args = this._getIntermediate(), true) && this._rule("curlyTrans", false, [], null, this["curlyTrans"]) && (body = this._getIntermediate(), true) && this._exec(function() {
        return this._cons("function " + (name || "") + "(" + args.join(",") + ")").cons(body);
    }.call(this));
};

BSJSTranslator.prototype["call"] = function $call() {
    var fn, tfn, $l20, $l21, args;
    return this._skip() && (fn = this._getIntermediate(), true) && this._rule("trans", false, [ fn ], null, this["trans"]) && (tfn = this._getIntermediate(), true) && ($l20 = this, $l21 = $l20.op, $l20.op = "()", true) && (this._rule("mtrans", false, [], null, this["mtrans"]) && (args = this._getIntermediate(), true) && this._exec(function() {
        if (fn[1] === null) tfn = this._cons("(").cons(tfn).cons(")");
        return tfn.cons("(").cons(args.join(",")).cons(")");
    }.call(this)) && ($l20.op = $l21, true) || ($l20.op = $l21, false));
};

BSJSTranslator.prototype["send"] = function $send() {
    var msg, recv, args;
    return this._skip() && (msg = this._getIntermediate(), true) && this._rule("trans", false, [], null, this["trans"]) && (recv = this._getIntermediate(), true) && this._rule("mtrans", false, [], null, this["mtrans"]) && (args = this._getIntermediate(), true) && this._exec(function() {
        return recv.cons("." + msg + "(").cons(args.join(",")).cons(")");
    }.call(this));
};
...
BSJSTranslator.prototype["new"] = function $new() {
    ...
    return (this._atomic(function() {
        ...
        return this._rule("trans", false, [], null, this["trans"]);
    })) && (cls = this._getIntermediate(), true) && this._rule("mtrans", false, [], null, this["mtrans"]) && (args = this._getIntermediate(), true) && this._exec(function() {
        return this._cons("new ").cons(cls).cons("(").cons(args.join(",")).cons(")");
    }.call(this));
};
...
BSJSTranslator.prototype["var"] = function $var() {
    ...
    }) && (vs = this._getIntermediate(), true) && this._exec(function() {
        return this._cons("var ").cons(vs.join(","));
    }.call(this));
};
...
BSJSTranslator.prototype["varItem"] = function $varItem() {
    return this._atomic(function() {
        ...
        return this._list(function() {
            ...
            if (v[0] === "binop" && v[1] === ",") {
                return res = res.cons("(").cons(tv).cons(")");
            } else {
                return res = res.cons(tv);
            }
        }.call(this));
    }) || this._atomic(function() {
        var n;
...
BSJSTranslator.prototype["throw"] = function $throw() {
    var x;
    return this._rule("trans", false, [], null, this["trans"]) && (x = this._getIntermediate(), true) && this._exec(function() {
        return this._cons("throw ").cons(x);
    }.call(this));
};

BSJSTranslator.prototype["try"] = function $try() {
    var x, name, c, f;
    return this._rule("curlyTrans", false, [], null, this["curlyTrans"]) && (x = this._getIntermediate(), true) && this._skip() && (name = this._getIntermediate(), true) && this._rule("curlyTrans", false, [], null, this["curlyTrans"]) && (c = this._getIntermediate(), true) && this._rule("curlyTrans", false, [], null, this["curlyTrans"]) && (f = this._getIntermediate(), true) && this._exec(function() {
        return this._cons("try ").cons(x).cons("catch(" + name + ")").cons(c).cons("finally").cons(f);
    }.call(this));
};

BSJSTranslator.prototype["json"] = function $json() {
    var $l22, $l23, props;
    return ($l22 = this, $l23 = $l22.op, $l22.op = "{}", true) && (this._rule("mtrans", false, [], null, this["mtrans"]) && (props = this._getIntermediate(), true) && this._exec(function() {
        return this._cons("{").cons(props.join(",")).cons("}");
    }.call(this)) && ($l22.op = $l23, true) || ($l22.op = $l23, false));
};

BSJSTranslator.prototype["binding"] = function $binding() {
    var name, val;
    return this._skip() && (name = this._getIntermediate(), true) && this._rule("trans", false, [], null, this["trans"]) && (val = this._getIntermediate(), true) && this._exec(function() {
        return this._cons(JSON.stringify(name) + ": ").cons(val);
    }.call(this));
};

BSJSTranslator.prototype["switch"] = function $switch() {
    var x, cases;
    return this._rule("trans", false, [], null, this["trans"]) && (x = this._getIntermediate(), true) && this._rule("mtrans", false, [], null, this["mtrans"]) && (cases = this._getIntermediate(), true) && this._exec(function() {
        return this._cons("switch(").cons(x).cons("){").cons(cases.join(";")).cons("}");
    }.call(this));
};

BSJSTranslator.prototype["case"] = function $case() {
    var x, y;
    return this._rule("trans", false, [], null, this["trans"]) && (x = this._getIntermediate(), true) && this._rule("trans", false, [], null, this["trans"]) && (y = this._getIntermediate(), true) && this._exec(function() {
        return this._cons("case ").cons(x).cons(": ").cons(y);
    }.call(this));
};

BSJSTranslator.prototype["default"] = function $default() {
    var y;
    return this._rule("trans", false, [], null, this["trans"]) && (y = this._getIntermediate(), true) && this._exec(function() {
        return this._cons("default: ").cons(y);
    }.call(this));
};
