...
BSJSParser.prototype["func"] = function $func() {
    ...
    }) && (n = this._getIntermediate(), true) && this._rule("token", true, [ "(" ], null, this["token"]) && this._rule("listOf", false, [ "formal", "," ], null, this["listOf"]) && (fs = this._getIntermediate(), true) && this._rule("token", true, [ ")" ], null, this["token"]) && this._rule("curlySrcElems", false, [], null, this["curlySrcElems"]) && (body = this._getIntermediate(), true) && this._exec([ "func", n || null, fs, body ]);
};
...
BSJSParser.prototype["block"] = function $block() {
    var ss;
    return this._rule("curlySrcElems", false, [], null, this["curlySrcElems"]) && (ss = this._getIntermediate(), true) && this._exec(ss);
};
...
BSJSParser.prototype["curlySrcElems"] = function $curlySrcElems() {
    var ss;
    return this._rule("token", true, [ "{" ], null, this["token"]) && this._any(function() {
        return this._atomic(function() {
            return this._rule("srcElem", false, [], null, this["srcElem"]);
        });
    }) && (ss = this._getIntermediate(), true) && this._rule("token", true, [ "}" ], null, this["token"]) && this._exec([ "begin" ].concat(ss));
};
...
BSJSTranslator.prototype["trans"] = function $trans() {
    var t, ans, r;
    return this._list(function() {
        return this._skip() && (t = this._getIntermediate(), true) && this._rule("apply", false, [ t ], null, this["apply"]) && (ans = this._getIntermediate(), true) && this._exec(this._cons(ans)) && (r = this._getIntermediate(), true);
    }) && this._exec(r);
};
...
BSJSTranslator.prototype["arr"] = function $arr() {
    var $l0, $l1, xs;
    return ($l0 = this, $l1 = $l0.op, $l0.op = "[]", true) && (this._rule("mtrans", false, [], null, this["mtrans"]) && (xs = this._getIntermediate(), true) && this._exec(function() {
...
BSJSTranslator.prototype["begin"] = function $begin() {
    ...
    return this._atomic(function() {
        ...
        }) && (xs = this._getIntermediate(), true) && this._exec(this._cons("{").cons(this._arrcons(xs).join("")).cons("}"));
    });
};
...
BSJSTranslator.prototype["call"] = function $call() {
    ...
    return this._skip() && (fn = this._getIntermediate(), true) && this._rule("trans", false, [ fn ], null, this["trans"]) && (tfn = this._getIntermediate(), true) && ($l18 = this, $l19 = $l18.op, $l18.op = "()", true) && (this._rule("mtrans", false, [], null, this["mtrans"]) && (args = this._getIntermediate(), true) && this._exec(function() {
...
BSJSTranslator.prototype["var"] = function $var() {
    ...
    return this._many(function() {
        ...
        return this._cons("var ").cons(this._arrcons(vs).join(","));
    }.call(this));
};
...
BSJSTranslator.prototype["json"] = function $json() {
    var $l20, $l21, props;
    return ($l20 = this, $l21 = $l20.op, $l20.op = "{}", true) && (this._rule("mtrans", false, [], null, this["mtrans"]) && (props = this._getIntermediate(), true) && this._exec(function() {
