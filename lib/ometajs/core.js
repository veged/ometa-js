...
//
function invokeCode(parser, code, args) {
  return code.apply(parser, args.map(function(key) {
...
AbstractParser.prototype.simulate = function simulate(fns, args) {
  var self = this,
      result = fns.map(function(fn) {
        return invokeCode(self, fn, args);
      });
...
AbstractParser.prototype.predicate = function predicate(fn, args) {
  return invokeCode(this, fn, args) ? true : false;
};
...
//
AbstractParser.prototype.exec = function body(code, args) {
  this.intermediate = invokeCode(this, code, args);
  return true;
};
...
AbstractParser.prototype.body = function body(code, args) {
  this.result = this.intermediate = invokeCode(this, code, args);
  return true;
};
...
AbstractGrammar.prototype._rule_char = function _rule_char() {
  return this.enter('char', 0, function() {
    return propagateResult(this, function() {
      return genericMatch(this, function(curr) {
...
AbstractGrammar.prototype._rule_letter = function _rule_letter() {
  return this.enter('letter', 0, function() {
    return propagateResult(this, function() {
      return genericMatch(this, function(curr) {
...
AbstractGrammar.prototype._rule_digit = function _rule_digit() {
  return this.enter('digit', 0, function() {
    return propagateResult(this, function() {
      return genericMatch(this, function(curr) {
        return /^\d$/.test(curr);
      });
...
AbstractGrammar.prototype._rule_seq = function _rule_seq() {
  return this.enter('seq', 0, function() {
    return propagateResult(this, function() {
